...
import "../../../ComponentsCss/IncomeTax/Sections/ExemptionSec10.css";
import { GlobalContext } from "../../../../context/GlobalContext/GlobalContext";

const INITIAL_ROWS = [
  {
    id: 1,
    particular: "Petrol Reimbursement",
    yearlyLimit: "0.00",
    planned: "",
    actual: "",
    approved: "",
  ...
  {
    id: 2,
    particular: "Internet Expenses Reimbursement",
    yearlyLimit: "0.00",
    planned: "",
    actual: "",
    approved: "",
  ...
  {
    id: 3,
    particular: "Periodical Journals",
    yearlyLimit: "0.00",
    planned: "",
    actual: "",
    approved: "",
...
export default function ExemptionSec10({ selectedEmployee: externalSelectedEmployee = null, onEmployeeSelect = null }) {
    ...
    <div className="company_container">
      ...
      <div className="tax-option-card">
        <div className="tax-option-card-header">
          <div>
            <h2>Exemption Under Section 10</h2>
          </div>
        ...
        {selectedEmployee ? (
          ...
          <div className="tax-empty-state">
            Search and select an employee to display Exemption Section 10 details here.
          </div>
        )}
      </div>
